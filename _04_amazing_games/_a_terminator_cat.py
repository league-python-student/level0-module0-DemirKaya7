...
#        for i in range(50):
            ...
            self.turtle.begin_fill()
            self.turtle.goto(self.x, self.y + 15)
            self.turtle.circle(radius=(self.radius)/2, steps=20)
            self.turtle.end_fill()

            myTurtle.color("purple", "purple")
            self.turtle.begin_fill()
            self.turtle.goto(self.x, self.y + 17)
            self.turtle.circle(radius=(self.radius)/3, steps=20)
            self.turtle.end_fill()
...
if __name__ == '__main__':
    ...
    leftEye = Eye(turtle=myTurtle, x=-32, y=12, radius=30)
    rightEye = Eye(turtle=myTurtle, x=47, y=-7, radius=30)
